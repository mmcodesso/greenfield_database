-- Teaching objective: Produce a detailed annual income statement from posted general-ledger activity.
-- Main tables: GLEntry, Account, JournalEntry.
-- Output shape: One row per fiscal year and income-statement line.
