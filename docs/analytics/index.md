...
| Curated report packs | [Reports Hub](reports/index.md) | guided lens packs plus preview-first Excel and CSV outputs for standard financial, managerial, and audit reporting | [Reports Lens Hub](reports/lens-packs.md), [Financial Reports](reports/financial.md), [Managerial Reports](reports/managerial.md), [Audit Reports](reports/audit.md) | sample-table preview before download |
...
- Use [Reports Hub](reports/index.md) when you want either a guided learning lens or a curated preview-and-download layer before moving into raw SQL.
