...
| Auditing | [Audit Analytics](audit.md) | [queries/audit](https://github.com/mmcodesso/greenfield_database/tree/main/queries/audit) | operational document sheets, payroll sheets, `TimeClockEntry`, `AttendanceException`, `GLEntry`, `JournalEntry`, `AnomalyLog`, `ValidationSummary` |
