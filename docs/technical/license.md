...
- use the material for educational or commercial purposes
...
- distribute adaptations under the same license terms

You may not apply legal or technical restrictions that prevent others from using the material under the same license.
...
This repository is published as an open educational resource and is intended for reuse, adaptation, and course adoption under `CC BY-SA 4.0`.
