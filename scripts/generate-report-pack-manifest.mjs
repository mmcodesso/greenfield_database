...
function normalizePack(pack) {
  return {
    ...
    openingParagraphs: Array.isArray(pack.opening_paragraphs) ? pack.opening_paragraphs.map(String) : [],
    approachGuidance: Array.isArray(pack.approach_guidance) ? pack.approach_guidance.map(String) : [],
